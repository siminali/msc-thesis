...
## Run Information
- **Run ID**: 20250816_194323
- **Model**: Explicit Conditioned
- **Timestamp**: 2025-08-16 19:43:26
- **Device**: cpu
...
```bash
python src/evaluate_model.py --model-name explicit_conditioned --run-id 20250816_194323
```
