# Llm Conditioned Training Run Summary

## Run Information
- **Run ID**: 20250816_194510
- **Model**: Llm Conditioned
- **Timestamp**: 2025-08-16 19:45:16
- **Device**: cpu
...
## Training Results
- **Best Validation Loss**: 11.479694
- **Best Epoch**: N/A
...
```bash
python src/evaluate_model.py --model-name llm_conditioned --run-id 20250816_194510
```
