...
## Run Information
- **Run ID**: 20250816_194604
- **Model**: Llm Conditioned
- **Timestamp**: 2025-08-16 20:09:48
- **Device**: cpu
...
```bash
python src/evaluate_model.py --model-name llm_conditioned --run-id 20250816_194604
```
